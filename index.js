...
async function startScraper(page) {
    for (const groupId of groupsIds) {
     ...
     try {
        ...
        params.append('to', config.username);
        params.append('content', postsArr.join('<br><br>'));
        let res = await axios.post('https://shaharmeshulam.co.il/email-post.php', params);
        console.log(res.data);
        params.set('to', 'livne@s-tov.org.il');
        res = await axios.post('https://shaharmeshulam.co.il/email-post.php', params);
        console.log(res.data);
...
async function scrape(page, groupId) {
    var posts;
    try {
        /* Go to group */
